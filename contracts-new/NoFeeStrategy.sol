...
/**
 * @notice strategy for StakingRewards
 */
contract NoFeeStrategy is BaseStrategy {
    ...
    function _deposit(address account, uint amount) private onlyAllowedDeposits {
        require(DEPOSITS_ENABLED == true, "HmbStrategy::_deposit");
    ...
    function _stakeDepositTokens(uint amount) private {
        require(amount > 0, "NoFee::_stakeDepositTokens");
