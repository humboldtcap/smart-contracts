...
/**
 * @notice Strategy should be inherited by new strategies
 */
abstract contract BaseStrategy is HmbERC20, Ownable, Permissioned {
     ...
     */
    modifier onlyEOA() {
        require(tx.origin == msg.sender, "HmbStrategy::onlyEOA");
        _;
    }
     ...
     */
    modifier onlyDev() {
        require(msg.sender == devAddr, "HmbStrategy::onlyDev");
        _;
    }
